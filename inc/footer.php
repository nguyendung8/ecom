                    ...
                    <div class="f-logo">
                        <ul class="footer-ul">
                            <li class="footer-li footer-logo">
                                <a href="index.html">
                                    <img class="img-fluid" src="https://image.donghohaitrieu.com/wp-content/uploads/2023/08/logo.png" alt="">
                                </a>
                            </li>
                ...
                <div class="col">
                    <ul class="f-bottom">
                        <li class="f-c f-copyright">
                            <p>Copyright <i class="fa fa-copyright"></i> ME</p>
                        </li>
                        ...
                        <li class="f-c f-payment">
                            <a href="checkout.html"><img src="assets/image/payment.png" class="img-fluid"
                                    alt="payment image"></a>
                        </li>
                    </ul>
                </div>
